...
class DeviceConstraints:
    ...
    """Class for specifying any characteristics of the target quantum
    processor that the optimizer must respect in order for the resulting
    subcircuits to be executable on the target processor. The constraints
    are trivial for LO cuts. Further constraints will be added as LOCC
    is incorporated.
