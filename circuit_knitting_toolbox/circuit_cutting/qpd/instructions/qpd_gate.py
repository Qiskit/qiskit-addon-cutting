...
class BaseQPDGate(Instruction, ABC):
    ...
    def basis(self) -> QPDBasis:
        ...
        Returns:
            - (QPDBasis): The basis to which the gate should be decomposed
        """
        return self._basis
...
class TwoQubitQPDGate(BaseQPDGate):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize the two qubit QPDGate.
...
class SingleQubitQPDGate(BaseQPDGate):
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize the single qubit QPDGate, and assign member variables.
